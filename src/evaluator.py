...
def fit_link_predictor(X, tvt_edges_file, device, batch_size, neg_rate, es_metric='auc', epochs=200, patience=50, repeat=5):
    ...
    for _ in range(repeat):
        ...
        model = src.model.Link_Pred_v2(X.shape[1])
